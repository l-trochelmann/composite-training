dataset_info = dict(
    ...
    skeleton_info={
        ...
        2: dict(link=('left_shoulder', 'left_elbow'), id=4, color=[255, 0, 255]),
        3: dict(link=('left_elbow', 'left_wrist'), id=5, color=[255, 0, 255]),
        4: dict(link=('right_ankle', 'right_knee'), id=6, color=[255, 0, 255]),
        5: dict(link=('right_knee', 'right_hip'), id=7, color=[255, 0, 255]),
        6: dict(link=('right_hip', 'left_hip'), id=8, color=[255, 0, 255]),
        7: dict(link=('left_hip', 'left_knee'), id=9, color=[255, 0, 255]),
        8: dict(link=('left_knee', 'left_ankle'), id=10, color=[255, 0, 255]),
        9: dict(link=('right_shoulder', 'right_hip'), id=12, color=[255, 0, 255]),
        10: dict(link=('left_shoulder', 'left_hip'), id=13, color=[255, 0, 255]),

        11: dict(link=('right_shoulder', 'neck'), id=2, color=[0, 0, 255]),
        12: dict(link=('neck', 'left_shoulder'), id=3, color=[0, 0, 255]),
        13: dict(link=('head_top', 'neck'), id=11, color=[0, 0, 255]),

        14: dict(link=('left_eye', 'right_eye'), id=12, color=[255, 0, 0]),
        15: dict(link=('nose', 'left_eye'), id=13, color=[255, 0, 0]),
        16: dict(link=('nose', 'right_eye'), id=14, color=[255, 0, 0]),
        17: dict(link=('left_eye', 'left_ear'), id=15, color=[255, 0, 0]),
        18: dict(link=('right_eye', 'right_ear'), id=16, color=[255, 0, 0]),
        19: dict(link=('left_ear', 'left_shoulder'), id=17, color=[255, 0, 0]),
        20: dict(link=('right_ear', 'right_shoulder'), id=18, color=[255, 0, 0]),
        21: dict(link=('left_shoulder', 'right_shoulder'), id=7, color=[255, 0, 0])
    },
